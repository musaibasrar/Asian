...
<body>
	...
	<form id="form1"
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD">Stock Purchased Report <br>
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Item Code</th>
				...
				<tbody>
					...
					<c:forEach items="${messstockentrylist}" var="messstockentrylist" varStatus="status">
						<tr style="border-color: #000000" border="1" cellpadding="1"
						  ...
						  <td class="dataText"><c:out value="${messstockentrylist.itemid}" /></td>
