        ...
        <div id="container" style="width: 95%;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="Controller?process=MessItemsMoveProcess&action=issueItems" style="font-size: 12px;">Generate</a>
            			</td>
            		</tr>
            		
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				<a target="mainFrame" href="Controller?process=MessItemsMoveProcess&action=billsReport" style="font-size: 12px;">Bills Report</a>
            			</td>
            		</tr>
            	</table>
            </div>
        	...
        	<div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="Controller?process=MessItemsProcess&action=purchaseItems" style="font-size: 12px;">Purchase</a>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="Controller?process=MessItemsProcess&action=receiveStock" style="font-size: 12px;">Stock Purchased Report</a>
            			</td>
            		</tr>
            	</table>
            </div>
