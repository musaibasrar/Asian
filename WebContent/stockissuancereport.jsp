				...
				<div id="tabs-1">
					...
					<table style="margin-left: auto;margin-right: auto;">
						...
						<tr>
							...
							<td class="alignRight">Medicine&nbsp;</td>
							<td ><label>
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Customer</th>
				...
				<tbody>
					...
					<c:forEach items="${stockissuancelist}" var="stockissuancelist" varStatus="status">
						<tr style="border-color: #000000" border="1" cellpadding="1"
						  ...
						  <td class="dataText">
						  <fmt:parseNumber var = "salesrate" type = "number" value = "${stockissuancelist.purpose}" />
						  <c:out value="${salesrate}" /></td>
						  <td class="dataText">
						  <c:set var="itemTotal" value="${itemTotal + salesrate * stockissuancelist.quantity}" />
						  <fmt:setLocale value="en_IN" scope="request"/>
							<fmt:formatNumber type="currency"  value="${salesrate * stockissuancelist.quantity}" />
						  </td>
						</tr>
					</c:forEach>
