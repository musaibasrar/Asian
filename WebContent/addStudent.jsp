...
<script type="text/javascript">
	$(function() {
		...
		$("#savestudents").button().click(function() {
			addStudent();
				...
				<div id="fragment-1">
					<table  style="width: auto;height: auto;" align="center"   border="0" id="table1">
						...
						<tr>
							...
							<td class="alignLeft" style="padding-left: 20px;">Contact Number* &nbsp;</td>
									...
									<td><label> <input
											...
											style="text-transform:uppercase;height: 18px;font-size: 13px;font-weight: bold;"
											id="addclass" size="30" maxlength="10" minlength="10">
						...
						<tr>
							...
							<td align="left"><label> <input
									name="remarks" type="text" class="myclass" id="remarks" size="30" required
									style="text-transform:uppercase;height: 18px;font-size: 13px;font-weight: bold;"
									required>
							</label></td>
						</tr>
...
<tr>
	...
	<script type="text/javascript">
							...
							function generateBill() {
								...
								if(form1.checkValidity()) {
									form1.savestudent.disabled = true;
									form1.action = "Controller?process=StudentProcess&action=generateBill";
									form1.submit();
								  }
							}
