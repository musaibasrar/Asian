...
<script type="text/javascript">
	...
	function selectAllRow(tableID){
	 ...
	 function calculate(value2) {
      	...
      	var price=document.getElementById("purchaseprice_"+value2).value;
	...
	function addRow() {
        ...
        var newRow = $("<tr class='trClass'>"+col1+col2+col3+col4+col5+col6+col7+col8+"</tr>");
        $(function() {
...
<body>
	<form id="form1" method="POST">
		...
		<div class="alert-box success" id="div1">Items has been purchased successfully!!!&nbsp;&nbsp;&nbsp;<button class="button" id="1" onclick="closediv(this.id);">OK</button></div>
					...
					<table style="margin-left: auto;margin-right: auto;border: 1px solid black;" id="dataTable">
						...
						<tbody>						
							...
							<tr>
								...
								<td colspan="7" align="right" style="font-weight: bold;">Transportation & Labour Charges&nbsp;&nbsp;</td>
								<td align="center"><input type="text"
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD">Items Purchased List</td>
				</tr>
			</table>
