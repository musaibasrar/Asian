    ...
    transition: 0.3s;
        ">
						...
						<tr>
							...
							<td style="width: 120px;"><a target="leftFrame" href="left_admin_side.jsp"> <img
							...
							<td style="width: 100px;"><a target="mainFrame"
								href="Controller?process=MessItemsMoveProcess&action=issueItems"> <img
							...
							<td ><a target="mainFrame"
								href="Controller?process=MessItemsMoveProcess&action=billsReport"><img
							...
							<td><a target="mainFrame"
								href="Controller?process=StudentProcess&action=addNew"> <img
									src="images/customer.svg" width="18" height="18"
