				...
				<tr style="display: none;">
					...
					<table style="width:auto; height:auto;" border="0" align="center" id="table1">
						...
						<tr>
							...
							<td  class="left"><input
									name="classsec" type="text" 
									value="<c:out value="${student.classstudying}" />" class="textField"
									id="classsec" size="30" >

							</td>

							<td  class="alignLeft" style="display: none;">Gender &nbsp;</td>

							<td  class="left" style="display: none;">Male<input type="checkbox"
						...
						<tr>
							...
							<td > <input
									...
									value="<c:out value="${student.remarks}" />" class="textField"
									id="remarks" size="30" >
							</label></td>
						</tr>
...
<tr>
						...
						<tr style="display: none;">
							...
							<label> 
									<select name="classsec1" id="classsec1"
									style="width: 120px;">
