...
<script type="text/javascript">
	...
	var itemlist=[
        <c:forEach varStatus="status" items="${messstockitemdetailslist}" var="itemlist">{
                ...
                purchaseprice:'<c:out default="0" value="${itemlist.externalid}" />',
        ...
        $(function() {
            $("#items_name_"+rowCount).autocomplete({
                ...
                change:function(event,ui){
                    ...
                    $("#purchaseprice_"+rowCount).val( ui.item.purchaseprice );
                },
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				...
				<div id="tabs-1">
							...
							<td >
								...
								<div class="container">
										<div class="row">
										        ...
										        </select>&nbsp;&nbsp;<a target="mainFrame" href="Controller?process=StudentProcess&action=addNew">New Customer</a>
									 	</div>
								</div>
					...
					<div align="center">
						<p>
						<h2 style="text-decoration: underline;color: #eb6000">Medicine Details</h2>	
