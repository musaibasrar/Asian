...
<body>
	...
	<form id="form1" method="POST">
		...
		<div class="alert-box success" id="div1">Bill has been generated successfully!!!&nbsp;&nbsp;&nbsp;<button class="button" id="1" onclick="closediv(this.id);">OK</button></div>
		<div class="alert-box failure" id="div2">Bill generation failed, please try again!!!&nbsp;&nbsp;&nbsp;<button class="buttonred" id="2" onclick="closediv(this.id);">OK</button></div>
		
		<jsp:useBean id="now" class="java.util.Date" scope="page" />
		<div style="height: 28px">
			<button id="add">Billing Details</button>
			<br />
		</div>
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				...
				<div id="tabs-1">
					...
					<table>
						...
						<tr>
							...
							<td style="display: none;"><label> <select name="purpose"
									id="purpose" class="dropdownlist" style="font-size: 14px;">
										...
										<div class="row">
										        <select name="issuedto"	id="issuedto" style="font-size: 24px;width: 220px;"  class="form-control select2" required>
										        	...
										        	<c:forEach items="${studentList}" var="student">
										        		...
										        		<option value="${student.student.name}">${student.student.name}</option>
										        	</c:forEach>
										        </select>
									 	</div>
								</div>
							...
							<label>
									<!-- <input  type="text" name="customername" id="customername" class="textfieldvalues" style="width: 200px" />
									<input  type="text" name="issuedto" id="issuedto" style="width: 200px" class="input-hidden" required/> -->
									
									<!-- 
									<select name="issuedto"
									id="issuedto" class="dropdownlist" style="font-size: 14px;" >
										<option selected="selected">Customer Name</option>
										<option></option>
										<option></option>
								</select> -->
					...
					<div align="left">
							<button id="saveissueentry">Generate</button>
							<br><br>
					</div>
			 ...
			 <table style="float:center;border-color: #4b6a84;width: 50%" id="dataTableOne">
				...
				<tfoot>
						<tr>
							<td class="footerTD" colspan="2"><label style="font-size: 14px;color: white;">&nbsp;&nbsp;&nbsp;</label></td>
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD">Medicines Issue List</td>
				</tr>
			</table>
				...
				<tbody>
					...
					<c:forEach items="${messstockmovelist}" var="stockmovelist">
						<tr style="border-color: #000000" border="1" cellpadding="1"
							cellspacing="1">
                          <td class="dataTextLeft" style="text-align: center;"><input type="checkbox" id = "<c:out value="${stockmovelist.id}"/>" class = "chcktbl"  name="stockmoveid"  value="<c:out value="${stockmovelist.id}"/>"/></td>
