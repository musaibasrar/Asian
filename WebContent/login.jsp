 ...
 <script type="text/javascript">
	...
	<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			...
			<span class="company__logo"><h2><img border="0" style="vertical-align: text-bottom;height: 120px;width: 200px;" alt="ideoholic" src="images/asianagencies.png"></h2></span>
