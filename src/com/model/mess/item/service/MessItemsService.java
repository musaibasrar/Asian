	...
	public void savePurchase() {
		...
		if(httpSession.getAttribute(BRANCHID)!=null){
				...
				if(itemIds!=null) {
					...
					for(int i=0; i < itemIds.length ; i++){
						...
						messStockEntry.setItemunitprice(Float.parseFloat(salesPrice[i]));
						...
						int crSupplierLedgerId = getLedgerAccountId("cashinhandaccountid");
		...
		public void generateStockIssuanceReport() {
			...
			if(!issueTo.isEmpty()) {
				...
				httpSession.setAttribute("issuedtoselected", "Customer Name:&nbsp;"+issueTo);
			}else {
			...
			httpSession.setAttribute("transactionfromdateselected", "Date:"+request.getParameter("transactiondatefrom"));
